...
(* Same as hax-lib proof-libs/fstar/core/Core_models.Ops.Range.fst, but with higher solver
   limits: the upstream file sets z3rlimit 15, which overrides Makefile --z3rlimit and makes
   cold (no hints) CI verification flaky or fail. This copy lives in ../stubs (last --include)
   so it shadows the bundled module. *)
